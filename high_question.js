(function ($) {
  ...
  const prefecturalCapital = [
    ...
    {
      id: "06",
      question: "欲しかったコンサートチケットをネットで検索したら、ＳＮＳ上で売っている人がいた。どうしたら良いでしょうか？",
      answer01: "怪しいので買わない",
      answer02: "相手に言われたとおり、チケットをもらう前にお金を支払う",
      answer03: "相手から先にチケットをもらった後、お金を支払わずにＳＮＳから退会する",
      answer04: "相手に信用してもらうために住所や氏名、連絡先を伝える",
    },
    {
      id: "07",
      question: "パソコンの画面にウイルス警告画面とサポートセンターの連絡先が表示された。対応として間違っているものはどれでしょうか？",
      answer01: "表示された連絡先へ電話する",
      answer02: "親や知人、警察へ相談する",
      answer03: "パソコンのブラウザを閉じる",
      answer04: "パソコンを強制終了する",
    },
    {
      id: "08",
