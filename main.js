(function ($) {
  ...
  const prefecturalCapital = [
    ...
    {
      id: "11",
      question: "友達の悪口が書いてあるメッセージを見つけました。どのように対応したら良いでしょうか？",
      answer01: "大人に注意してもらう",
    ...
    },
    {
      ...
      answer01: "炎上する",
      answer02: "人気者になる",
      answer03: "みんなに楽しんで貰える",
      answer04: "特定の人しか見ないから、特に悪影響はない",
    },
    {
      id: "13",
      question: "ネット上で知り合った人と会って遊ぼうと言われた。どのようにすればいいか",
      answer01: "親に相談する",
      answer02: "親に帰る時間を伝えて",
    ...
    {
      id: "14",
      question: "スマホを使って、疲れてきた。どのようにするべきか",
    ...
    {
      id: "15",
      question: "有名人がマンションに入っていくのを見かけた。どのようにするのが良いか",
      answer01: "特になにもしない",
    ...
    {
      id: "16",
      question: "「宝くじ当選」というタイトルのメールがきた。どのようにするべきか",
      answer01: "無視する",
    ...
    {
      id: "17",
      question: "知らないアドレスからアンケートのお願いメールが来た。どのようにするのが良いか",
      answer01: "知らないメールだから、解答しない",
      answer02: "お礼が良かったらする",
    ...
    {
      id: "18",
      question: "友達とゲームをしていたが、寝る時間になった。この後どのような行動を取るべきか",
      answer01: "健康に悪いから、寝る",
    ...
    {
      id: "19",
      question: "夏休みの課題として絵を描く課題が出た。この時の行動として適切な選択肢を選べ",
      answer01: "自分で考えて書く",
      answer02: "友達の作品を真似する",
      answer03: "アニメのキャラクターを写す",
      answer04: "やらない",
    },
    {
      id: "20",
      question: "スマホの使い方として正しい選択肢を選べ",
